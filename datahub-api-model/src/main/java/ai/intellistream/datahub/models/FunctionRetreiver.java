...
/** Request body of {@code POST /functions/filter}. Mirrors {@link ResourceRetreiver}. */
@Data
@Schema(name = "Function Query", description = "Function Query Object")
public class FunctionRetreiver {
    ...
    @Valid
    private FunctionFilter filter = new FunctionFilter();
