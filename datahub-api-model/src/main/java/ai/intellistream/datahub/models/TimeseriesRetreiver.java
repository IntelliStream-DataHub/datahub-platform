...
/** Request body of {@code POST /timeseries/filter}. Mirrors {@link ResourceRetreiver}. */
@Data
@Schema(name = "Timeseries Query", description = "Timeseries Query Object")
public class TimeseriesRetreiver {

    @Valid
    private TimeseriesFilter filter = new TimeseriesFilter();
