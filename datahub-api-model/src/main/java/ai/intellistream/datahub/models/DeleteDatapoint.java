...
public class DeleteDatapoint {
    ...
    @Schema(description = """
            Start of the window to clear, inclusive. Either ISO-8601 or a UTC epoch, in seconds \
            or milliseconds. \
    ...
    @Schema(description = """
            End of the window to clear, exclusive. Either ISO-8601 or a UTC epoch, in seconds \
            or milliseconds. \
