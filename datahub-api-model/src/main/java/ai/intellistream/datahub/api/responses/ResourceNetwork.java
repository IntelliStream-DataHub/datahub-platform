 ...
 * resources in that sub-graph, {@code edges} the relationships between them (directional —
 ...
 */
public record ResourceNetwork(Set<Resource> nodes, Set<EdgeProxy> edges, Set<LabelForm> labels) {
}
