...
public class ChatPrompt {
     ...
     * @param instructions this tenant's standing instructions, or null
     */
    public String build(ZoneId zone, String instructions) {
        ...
        // Tenant framing — domain vocabulary, tag conventions, what matters to this customer.
        // Appended rather than replacing the above so the tool discipline and the read-only framing
        // cannot be configured away by accident.
