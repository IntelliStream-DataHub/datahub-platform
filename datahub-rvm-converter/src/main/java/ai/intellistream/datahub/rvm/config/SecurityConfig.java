 ...
 * <em>user's own JWT</em> — the same token the browser presents to {@code /models} (and which this
...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
                // Browser-facing: the console calls /models from its own origin, so allow it.
