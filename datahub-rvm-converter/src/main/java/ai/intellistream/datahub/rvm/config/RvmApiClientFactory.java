 ...
 * security context and hands it to the SDK as a static token, so every api call this service makes
 ...
 */
@Component
public class RvmApiClientFactory {

    private final String apiBaseUrl;
    private final HttpClient httpClient = HttpClient.newHttpClient();

    public RvmApiClientFactory(@Value("${datahub.api.url:http://localhost:8081}") String apiBaseUrl) {
