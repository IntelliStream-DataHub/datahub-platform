...
@Schema(description="Retrieves a list of data points from multiple time series in a project.")
@Data
public class DataRetrieverForDatapoints {

    @Schema(description = "A list of DataRetrieverFilter objects for filtering data points.")
    private Collection<DataRetrieverFilter> items = new ArrayList<>();
